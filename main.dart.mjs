...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1338: x0 => globalThis.URL.revokeObjectURL(x0),
      _1339: x0 => x0.remove(),
      _1340: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1342: x0 => globalThis.URL.createObjectURL(x0),
      _1343: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1343(f,arguments.length,x0) }),
      _1344: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1350: (x0,x1) => x0.append(x1),
      _1351: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1352: (x0,x1) => x0.replaceChildren(x1),
      _1353: x0 => x0.click(),
      _1354: x0 => x0.decode(),
      ...
      _1389: x0 => new FinalizationRegistry(x0),
      _1390: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1392: (x0,x1) => x0.unregister(x1),
      _1394: () => globalThis.WeakRef,
      _1395: () => globalThis.FinalizationRegistry,
      _1397: x0 => x0.call(),
      _1398: s => JSON.stringify(s),
      _1399: s => printToConsole(s),
      _1400: (o, p, r) => o.replaceAll(p, () => r),
      _1401: (o, p, r) => o.replace(p, () => r),
      _1402: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1403: s => s.toUpperCase(),
      _1404: s => s.trim(),
      _1405: s => s.trimLeft(),
      _1406: s => s.trimRight(),
      _1407: (string, times) => string.repeat(times),
      _1408: Function.prototype.call.bind(String.prototype.indexOf),
      _1409: (s, p, i) => s.lastIndexOf(p, i),
      _1410: (string, token) => string.split(token),
      _1411: Object.is,
      _1412: o => o instanceof Array,
      _1413: (a, i) => a.push(i),
      _1417: a => a.pop(),
      _1418: (a, i) => a.splice(i, 1),
      _1419: (a, s) => a.join(s),
      _1420: (a, s, e) => a.slice(s, e),
      _1422: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1423: a => a.length,
      _1425: (a, i) => a[i],
      _1426: (a, i, v) => a[i] = v,
      _1428: o => {
      ...
      _1429: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1431: o => o instanceof Uint8Array,
      _1432: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1433: o => o instanceof Int8Array,
      _1434: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1435: o => o instanceof Uint8ClampedArray,
      _1436: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1437: o => o instanceof Uint16Array,
      _1438: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1439: o => o instanceof Int16Array,
      _1440: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1441: o => o instanceof Uint32Array,
      _1442: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1443: o => o instanceof Int32Array,
      _1444: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1446: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1447: o => o instanceof Float32Array,
      _1448: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1449: o => o instanceof Float64Array,
      _1450: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1451: (t, s) => t.set(s),
      _1452: l => new DataView(new ArrayBuffer(l)),
      ...
      _1559: (o, p) => o[p],
      _1560: (o, p, v) => o[p] = v,
      _1562: x0 => x0.arrayBuffer(),
      _1563: (x0,x1) => x0.sqlite3changeset_finalize(x1),
      _1564: (x0,x1) => x0.sqlite3session_delete(x1),
      _1565: (x0,x1) => x0.sqlite3_close_v2(x1),
      _1566: (x0,x1) => x0.sqlite3_finalize(x1),
      _1567: (x0,x1) => x0.dart_sqlite3_malloc(x1),
      _1568: (x0,x1) => x0.dart_sqlite3_free(x1),
      _1570: x0 => x0.sqlite3_initialize(),
      _1576: (x0,x1,x2,x3,x4) => x0.sqlite3_open_v2(x1,x2,x3,x4),
      _1577: (x0,x1) => x0.sqlite3_extended_errcode(x1),
      _1578: (x0,x1) => x0.sqlite3_errmsg(x1),
      _1579: (x0,x1) => x0.sqlite3_errstr(x1),
      _1580: (x0,x1) => x0.sqlite3_error_offset(x1),
      _1581: (x0,x1,x2) => x0.sqlite3_extended_result_codes(x1,x2),
      _1585: (x0,x1,x2,x3,x4,x5) => x0.sqlite3_exec(x1,x2,x3,x4,x5),
      _1586: (x0,x1,x2,x3,x4,x5,x6) => x0.sqlite3_prepare_v3(x1,x2,x3,x4,x5,x6),
      _1587: (x0,x1) => x0.sqlite3_bind_parameter_count(x1),
      _1588: (x0,x1,x2) => x0.sqlite3_bind_null(x1,x2),
      _1589: (x0,x1,x2,x3) => x0.sqlite3_bind_int64(x1,x2,x3),
      _1590: (x0,x1,x2,x3) => x0.sqlite3_bind_double(x1,x2,x3),
      _1591: (x0,x1,x2,x3,x4) => x0.dart_sqlite3_bind_text(x1,x2,x3,x4),
      _1592: (x0,x1,x2,x3,x4) => x0.dart_sqlite3_bind_blob(x1,x2,x3,x4),
      _1594: (x0,x1) => x0.sqlite3_column_count(x1),
      _1595: (x0,x1,x2) => x0.sqlite3_column_name(x1,x2),
      _1596: (x0,x1,x2) => x0.sqlite3_column_type(x1,x2),
      _1597: (x0,x1,x2) => x0.sqlite3_column_int64(x1,x2),
      _1598: (x0,x1,x2) => x0.sqlite3_column_double(x1,x2),
      _1599: (x0,x1,x2) => x0.sqlite3_column_bytes(x1,x2),
      _1600: (x0,x1,x2) => x0.sqlite3_column_text(x1,x2),
      _1601: (x0,x1,x2) => x0.sqlite3_column_blob(x1,x2),
      _1618: (x0,x1) => x0.sqlite3_step(x1),
      _1619: (x0,x1) => x0.sqlite3_reset(x1),
      _1620: (x0,x1) => x0.sqlite3_changes(x1),
      _1623: (x0,x1) => x0.sqlite3_last_insert_rowid(x1),
      _1624: (x0,x1) => x0.sqlite3_get_autocommit(x1),
      _1625: (x0,x1,x2,x3) => x0.dart_sqlite3_db_config_int(x1,x2,x3),
      _1640: (x0,x1,x2,x3) => x0.dart_sqlite3_register_vfs(x1,x2,x3),
      ...
      _1647: f => finalizeWrapper(f, function(x0,x1,x2,x3,x4) { return dartInstance.exports._1647(f,arguments.length,x0,x1,x2,x3,x4) }),
      _1648: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1648(f,arguments.length,x0,x1,x2) }),
      _1649: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1649(f,arguments.length,x0,x1,x2,x3) }),
      _1650: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1650(f,arguments.length,x0,x1,x2,x3) }),
      ...
      _1655: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1655(f,arguments.length,x0,x1,x2,x3) }),
      _1656: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1656(f,arguments.length,x0,x1,x2,x3) }),
      ...
      _1660: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1660(f,arguments.length,x0,x1) }),
      _1661: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1661(f,arguments.length,x0,x1) }),
      ...
      _1667: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1667(f,arguments.length,x0,x1,x2,x3) }),
      _1668: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1668(f,arguments.length,x0,x1,x2,x3) }),
      _1669: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1669(f,arguments.length,x0,x1,x2,x3) }),
      ...
      _1672: f => finalizeWrapper(f, function(x0,x1,x2,x3,x4) { return dartInstance.exports._1672(f,arguments.length,x0,x1,x2,x3,x4) }),
      _1673: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1673(f,arguments.length,x0,x1) }),
      _1674: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1674(f,arguments.length,x0,x1) }),
      _1675: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1675(f,arguments.length,x0,x1,x2) }),
      _1676: (x0,x1,x2) => x0.instantiateStreaming(x1,x2),
      _1680: (x0,x1) => new URL(x0,x1),
      _1681: (x0,x1) => globalThis.fetch(x0,x1),
      _1685: (x0,x1) => new SharedWorker(x0,x1),
      _1686: x0 => new Worker(x0),
      _1693: x0 => globalThis.BigInt(x0),
      _1694: x0 => globalThis.Number(x0),
      _1715: (x0,x1) => globalThis.IDBKeyRange.bound(x0,x1),
      _1716: (x0,x1,x2) => x0.open(x1,x2),
      _1717: x0 => ({autoIncrement: x0}),
      _1718: (x0,x1,x2) => x0.createObjectStore(x1,x2),
      _1719: x0 => ({unique: x0}),
      _1720: (x0,x1,x2,x3) => x0.createIndex(x1,x2,x3),
      _1721: (x0,x1) => x0.createObjectStore(x1),
      _1722: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1722(f,arguments.length,x0) }),
      _1724: (x0,x1,x2) => x0.transaction(x1,x2),
      _1725: (x0,x1) => x0.objectStore(x1),
      _1727: (x0,x1) => x0.index(x1),
      _1728: x0 => x0.openKeyCursor(),
      _1729: (x0,x1) => x0.getKey(x1),
      _1730: (x0,x1) => ({name: x0,length: x1}),
      _1731: (x0,x1) => x0.put(x1),
      _1732: (x0,x1) => x0.get(x1),
      _1733: (x0,x1) => x0.openCursor(x1),
      _1734: x0 => globalThis.IDBKeyRange.only(x0),
      _1735: (x0,x1,x2) => x0.put(x1,x2),
      _1736: (x0,x1) => x0.update(x1),
      _1737: (x0,x1) => x0.delete(x1),
      _1740: x0 => x0.name,
      _1741: x0 => x0.length,
      _1754: x0 => x0.continue(),
      _1755: () => globalThis.indexedDB,
      _1777: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1777(f,arguments.length,x0) }),
      _1779: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1780: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _2437: x0 => x0.width,
      _2439: x0 => x0.height,
      _2923: (x0,x1) => { x0.accept = x1 },
      _2937: x0 => x0.files,
      _2963: (x0,x1) => { x0.multiple = x1 },
      _2981: (x0,x1) => { x0.type = x1 },
      _3276: (x0,x1) => { x0.width = x1 },
      _3278: (x0,x1) => { x0.height = x1 },
      _3699: () => globalThis.window,
      _6262: x0 => x0.target,
      _6302: x0 => x0.signal,
      _6363: x0 => x0.firstChild,
      _6374: () => globalThis.document,
      _6456: x0 => x0.body,
      _6790: (x0,x1) => { x0.id = x1 },
      _6817: x0 => x0.children,
      _8136: x0 => x0.value,
      _8138: x0 => x0.done,
      _8302: x0 => x0.size,
      _8303: x0 => x0.type,
      _8310: x0 => x0.name,
      _8311: x0 => x0.lastModified,
      _8316: x0 => x0.length,
      _8321: x0 => x0.result,
      _8817: x0 => x0.url,
      _8819: x0 => x0.status,
      ...
      _8822: x0 => x0.headers,
      _8823: x0 => x0.body,
      _8835: x0 => x0.instance,
      _8837: () => globalThis.WebAssembly,
      _8859: x0 => x0.exports,
      _8867: x0 => x0.buffer,
      _10278: x0 => x0.result,
      _10279: x0 => x0.error,
      _10290: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10292: x0 => x0.oldVersion,
      _10371: x0 => x0.key,
      _10372: x0 => x0.primaryKey,
      _10374: x0 => x0.value,
      _11213: (x0,x1) => { x0.display = x1 },
      _12435: x0 => x0.name,
      _12532: x0 => x0.href,
      _12547: x0 => x0.pathname,
