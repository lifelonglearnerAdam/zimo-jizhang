            ...
            data: (budgets) => monthTotal.when(
              data: (total) {
                ...
                return _buildBudgetCard(
                  ...
                  monthBudget,
                  total,
                  () => _showSetBudgetDialog(null, monthBudget),
                );
              },
              loading: () => const Card(
                child: Padding(
              ...
              data: (expenses) {
                ...
                return Column(
                  children: expenseParents.map((parent) {
                    ...
                    final matched = expenses
                        .where((e) => e.categoryName == parent.name)
                        .firstOrNull;
                    ...
                    return _buildBudgetCard(
                      ...
                      catBudget,
                      actualTotal,
                      () => _showSetBudgetDialog(parent.id, catBudget),
                    );
                  }).toList(),
                );
              },
  ...
  void _showSetBudgetDialog(int? categoryId, int? currentBudget) {
    final controller = TextEditingController(
      text: currentBudget != null
          ? (currentBudget / 100).toStringAsFixed(0)
          : '',
    );
            ...
            onPressed: () {
              if (currentBudget != null) {
                ref
                    ...
                    .deleteBudget(categoryId: categoryId);
              }
              Navigator.pop(ctx);
            },
            child: Text(
              currentBudget != null ? '清除预算' : '取消',
