...
class _CategoriesPageState extends ConsumerState<CategoriesPage> {
            ...
            data: (parents) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    _buildCategoryGroup(parents[index], subsAsync),
              );
            },
  ...
  Widget _buildCategoryGroup(
    ...
    AsyncValue<List<CategoryWithParent>> subsAsync,
  ) {
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: [
          subsAsync.when(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () => _showEditDialog(sc.category),
                          ),
                          if (!sc.category.isDefault)
                            IconButton(
                              ...
                              onPressed: () => _confirmDelete(sc.category),
                            ),
                        ],
                      ),
                    ),
            ...
            error: (e, _) =>
                const Padding(padding: EdgeInsets.all(16), child: Text('加载失败')),
          ),
        ],
      ),
    );
